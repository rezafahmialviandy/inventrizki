<?php 
    ...
    $sql="select * from detail_barang_masuk where kode_transaksi='$kode_transaksi' and kode_barang='$kode_barang' limit 1";
...
<script>
    $('#submit').click(function(){
        var agree=confirm("Adakah Anda yakin ingin mengedit barang masuk ini?");
        if (!agree){
            return false;
        } else {
            ...
            $.ajax({
                type	: 'POST',
                url: 'pages/barang-masuk/ajax/edit-barang.php',
                data: data,
                processData: false,
                contentType: false,
                cache: false,
