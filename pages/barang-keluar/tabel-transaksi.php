        ...
        <tbody>
            <?php
                ...
                if (isset($_POST['bulan'])){
                    $bulan=$_POST['bulan'];
                    $tahun=$_POST['tahun'];
                    $sql="select * from barang_keluar m inner join detail_barang_keluar d on d.kode_transaksi=m.kode_transaksi INNER JOIN barang b on b.kode_barang=d.kode_barang where month(m.tanggal)='".$bulan."' and year(m.tanggal)='".$tahun."' group by m.kode_transaksi order by m.tanggal desc";
                }else {
                    $sql="select * from barang_keluar m inner join detail_barang_keluar d on d.kode_transaksi=m.kode_transaksi INNER JOIN barang b on b.kode_barang=d.kode_barang group by m.kode_transaksi order by m.tanggal desc";
                }
