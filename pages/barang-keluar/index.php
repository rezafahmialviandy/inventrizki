    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
                <a href="index.php?page=input-barang-keluar" class="btn btn-primary" role="button">Input Baru</a>
            </div>
            <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
  ...
  function tabel_transaksi(){
    ...
    if (jenis==1){
        $.ajax({
            ...
            dataType: "html",
            async : false,
            url: 'pages/barang-keluar/tabel-transaksi.php',
  ...
  function tabel_barang(){
    ...
    if (jenis==1){
        $.ajax({
            ...
            dataType: "html",
            async : false,
            url: 'pages/barang-keluar/tabel-barang-keluar.php',
            success: function(data) {
